      ...
      <div className="container flex h-16 max-w-screen-2xl items-center mx-auto px-4">
        <div className="mr-4 flex md:hidden">
          <Link href="/" className="mr-6 flex items-center space-x-2">
            <Image src="/logo.svg" alt="Glass UI Logo" width={32} height={32} />
          </Link>
        </div>
        <div className="mr-4 hidden md:flex">
          ...
          <NavigationMenu>
            <NavigationMenuList>
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="text-sm leading-tight text-muted-foreground">
                            Beautifully designed glassmorphism components built with Radix UI and Tailwind CSS.
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link href="/docs" className={cn(navigationMenuTriggerStyle(), "bg-transparent")}>
                    Documentation
                  </Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
